...
public class EntryRepositoryTests {
	...
	public void setUp() throws FileNotFoundException, IOException {
		...
		_repo = new EntryRepository("tests.cfg");
	}

	@Test
	public void add() throws ClassNotFoundException, IOException {
		_repo.add(_entry);
		List<Entry> loadedEntries = _repo.getByPersonEMail(_entry.getEmail());
	...
	public void update() throws ClassNotFoundException, IOException {
		...
		int numOfEntriesBeforeUpdate = _repo.getAll().size();
		_repo.update(_entry);
		int numOfEntriesAfterUpdate = _repo.getAll().size();
	...
	public void nonexistentEmail() throws ClassNotFoundException, IOException {
		add();
		List<Entry> loadedEntries = _repo.getByPersonEMail("johnn@gmail.com");
		assertEquals(0, loadedEntries.size());
	}
	...
	public void emailWithNoEntries() throws ClassNotFoundException, IOException {
		...
		List<Entry> loadedEntries = _repo.getByPersonEMail("jane@gmail.com");
		assertEquals(0, loadedEntries.size());
	}
	...
	public void getByCategory() throws ClassNotFoundException, IOException {
		add5Entries();
		List<Entry> loadedEntries = _repo.getByCategory("Jacquard");
		assertEquals(3, loadedEntries.size());
		assertEquals(loadedEntries.get(0).getEmail(), "jake@gmail.com");
		assertEquals(loadedEntries.get(1).getEmail(), "john@gmail.com");
		assertEquals(loadedEntries.get(2).getEmail(), "julie@gmail.com");
		
		loadedEntries = _repo.getByCategory("Satin");
		assertEquals(2, loadedEntries.size());
		assertEquals(loadedEntries.get(0).getEmail(), "jan@gmail.com");
		assertEquals(loadedEntries.get(1).getEmail(), "justin@gmail.com");
	...
	public void nonexistentCategory() throws ClassNotFoundException, IOException {
		add();
		List<Entry> loadedEntries = _repo.getByCategory("Basket");
		assertEquals(0, loadedEntries.size());
	}
	...
	public void categoryWithNoEntries() throws ClassNotFoundException, IOException {
		...
		category.setName("Twill");
		List<Entry> loadedEntries = _repo.getByCategory("Twill");
		assertEquals(0, loadedEntries.size());
	}
	...
	public void getAll() throws ClassNotFoundException, IOException {
		add5Entries();
		List<Entry> allEntries = _repo.getAll();
